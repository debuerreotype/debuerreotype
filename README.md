...
TODO redo sums with updated configuration file comments for debuerreotype rename
(perhaps consider redoing this test without "build-all.sh" or with a simplified variation that doesn't include so may configuration bits and is simply a reproducible rootfs tarball)
```
